package com.maisprati.bike.resources;
...
import com.maisprati.bike.services.BikeService;
...
public class BikeResource {
	...
	public ResponseEntity<Bike> findById(@PathVariable Long id) {
		Bike obj = service.findById(id);
		return ResponseEntity.ok().body(obj);
	}

	@PostMapping
	public ResponseEntity<Bike> insert(@RequestBody Bike obj) {
	...
	public ResponseEntity<Void> delete(@PathVariable long id) {
		...
		service.delete(id);
		return ResponseEntity.noContent().build();// noContent() = retorna uma resposta vazia
